...
void setup() {
   ...
   emic.say("[hxae<300,10>piy<300,10> brrrx<600,12> th<100> dey<600,10> tuw<600,15> yu<1200,14>_<300> "\
             ...
             "hxae<300,10>piy<300,10> brrrx<600,22> th<100> dey<600,19> dih<400,15>rr<300> kae<300,14> th<100>errr<200,12>ih<550,12>nn<200> _<300>" \
             "hxae<300,20>piy<300,20> brrrx<600,19> th<100> dey<600,15> tuw<600,17> yu<1400,15>] ");
   delay(2000);
   emic.say("[ae<400,10>nd meh<300,12>niy<500,10> m<100,13>ow<1000,13>rr<300,13>] ");
}
